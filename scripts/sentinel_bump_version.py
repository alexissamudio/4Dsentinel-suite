...
# dependencies = []
# ///
"""sentinel_bump_version.py - Sincroniza la version del plugin sentinel-agents.
...
Uso:
  uv run scripts/sentinel_bump_version.py --check
  uv run scripts/sentinel_bump_version.py --set 0.2.0
"""
