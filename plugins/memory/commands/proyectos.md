...
- Llamá `list_projects`.
- Presentá en español: nombre de cada proyecto y, si está disponible, su estado/tamaño
  (nodos/aristas) y cuándo se indexó.
- Si está vacío, sugerí correr `/indexar` en el repo que quieras.
