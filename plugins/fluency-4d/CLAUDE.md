...
- Cuando recibas la instrucción del checkpoint de memoria (fluency-4d, ~cada 50% de contexto, configurable vía FLUENCY_4D_SAVE_PCT), escribí `.claude/docs/estado-sesion.md` con encabezado de fecha, objetivo/frase 4D, decisiones tomadas y pendientes, y seguí con la tarea.
